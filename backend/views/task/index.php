        ...
        <div class="card-body">
            ...
            <?= GridView::widget([
                ...
                'summary' => '<div class="text-muted mb-2">
                    Showing <b>{begin}-{end}</b> of <b>{totalCount}</b> tasks
                </div>',
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'label' => 'Project',
                        'value' => fn($model) =>
                        $model->project ? $model->project->project_name : '-',
                    ...
                    [
                        ...
                        'value' => fn($model) =>
                        $model->assignee
                            ? trim($model->assignee->first_name . ' ' . $model->assignee->last_name)
                            : '-',
                        'filter' => Html::activeTextInput(
                            $searchModel,
                            'assigned_to',
...
<script>
    window.TASK_STATUS_URL = "<?= Url::to(['task/change-status']) ?>";
</script>